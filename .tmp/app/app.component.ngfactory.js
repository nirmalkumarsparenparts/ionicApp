...
var _View_MyApp0 = (function (_super) {
    ...
    _View_MyApp0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_20 = import19.viewFactory_Nav0(this.viewUtils, this.injector(20), this._appEl_20);
        this._Nav_20_4 = new import19.Wrapper_Nav(this.parentInjector.get(import25.ViewController, null), this.parentInjector.get(import31.NavControllerBase, null), this.parentInjector.get(import27.App), this.parentInjector.get(import21.Config), this.parentInjector.get(import22.Keyboard), new import20.ElementRef(this._el_20), this.parentInjector.get(import23.NgZone), this.renderer, this.parentInjector.get(import32.ComponentFactoryResolver), this.parentInjector.get(import24.GestureController), this.parentInjector.get(import33.TransitionController), this.parentInjector.get(import34.DeepLinker, null));
    ...
    _View_MyApp0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import41.Nav) && (20 === requestNodeIndex))) {
...
var _View_MyApp1 = (function (_super) {
    ...
    _View_MyApp1.prototype.createInternal = function (rootSelector) {
        ...
        this._Item_0_4 = new import42.Wrapper_Item(this.parent.parentInjector.get(import43.Form), this.parent.parentInjector.get(import21.Config), new import20.ElementRef(this._el_0), this.renderer, this.parent.parentInjector.get(import44.ItemReorder, null));
