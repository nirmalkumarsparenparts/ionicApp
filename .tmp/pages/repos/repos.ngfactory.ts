...
export class Wrapper_ReposPage {
  context:import0.ReposPage;
  changed:boolean;
  constructor(p0:any) {
    this.changed = false;
...
var renderType_ReposPage_Host:import2.RenderComponentType = (null as any);
class _View_ReposPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _ReposPage_0_4:Wrapper_ReposPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_ReposPage_Host0,renderType_ReposPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-repos',rootSelector,(null as any));
    this._appEl_0 = new import3.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_ReposPage0(this.viewUtils,this.injector(0),this._appEl_0);
    this._ReposPage_0_4 = new Wrapper_ReposPage(this.parentInjector.get(import8.NavController));
    this._appEl_0.initComponent(this._ReposPage_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._ReposPage_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.ReposPage) && (0 === requestNodeIndex))) { return this._ReposPage_0_4.context; }
...
function viewFactory_ReposPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_ReposPage_Host === (null as any))) { (renderType_ReposPage_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_ReposPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const ReposPageNgFactory:import10.ComponentFactory<import0.ReposPage> = new import10.ComponentFactory<import0.ReposPage>('page-repos',viewFactory_ReposPage_Host0,import0.ReposPage);
const styles_ReposPage:any[] = ([] as any[]);
var renderType_ReposPage:import2.RenderComponentType = (null as any);
class _View_ReposPage0 extends import1.AppView<import0.ReposPage> {
  _el_0:any;
  ...
  /*private*/ _expr_7:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_ReposPage0,renderType_ReposPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._MenuToggle_4_5 = new import14.Wrapper_MenuToggle(this.parentInjector.get(import24.MenuController),new import21.ElementRef(this._el_4),this.parentInjector.get(import22.ViewController,(null as any)),this._Navbar_2_4.context);
    this._ToolbarItem_4_6 = new import15.Wrapper_ToolbarItem(this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_4),this.renderer,this.parentInjector.get(import25.Toolbar,(null as any)),this._Navbar_2_4.context);
    ...
    this._ToolbarTitle_9_4 = new import18.Wrapper_ToolbarTitle(this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_9),this.renderer,this.parentInjector.get(import25.Toolbar,(null as any)),this._Navbar_2_4.context);
    ...
    this._text_17 = this.renderer.createText(this._el_16,'Repos view page',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import29.Icon) && (6 === requestNodeIndex))) { return this._Icon_6_3.context; }
    if (((token === import30.Button) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 7)))) { return this._Button_4_4.context; }
    if (((token === import31.MenuToggle) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 7)))) { return this._MenuToggle_4_5.context; }
    if (((token === import32.ToolbarItem) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 7)))) { return this._ToolbarItem_4_6.context; }
    if (((token === import33.ToolbarTitle) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 10)))) { return this._ToolbarTitle_9_4.context; }
    ...
    if (((token === import35.Content) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 18)))) { return this._Content_14_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_ReposPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.ReposPage> {
  if ((renderType_ReposPage === (null as any))) { (renderType_ReposPage = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,styles_ReposPage,{})); }
